...
public class LogicaMenu extends AppCompatActivity {
    ...
    ListView l1;
    EditText txtcom,txtprecio,txtiempo,txtnombre;
    TextView tv1,tv2,tv3,tv4,tv5,tv6,tv7;
    Button btnain,btnacom,btnext1,btnext3,btnext2;
    Spinner spci,spi,spcat;
    List<String> opciones= new ArrayList<>();
    ArrayAdapter<String> ad;
    JSONObject medio=new JSONObject();
    String[]fruta=null,grano=null,carne=null,lacteo=null,vegetal=null;
